...
{
    /// <inheritdoc />
    public partial class InitialFarmManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FarmManagers", x => new { x.FarmId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FarmManagers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
